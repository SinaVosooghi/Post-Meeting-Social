...
describe('Authentication Pages', () => {
  ...
  describe('Sign In Page', () => {
    it('should render sign in page with correct title and description', () => {
      ...
      expect(screen.getByText('Transform your meeting transcripts into engaging social media content')).toBeInTheDocument();
    });
    ...
    it('should show required permissions information', () => {
      ...
      expect(screen.getByText('📅 Google Calendar access for meeting synchronization')).toBeInTheDocument();
      expect(screen.getByText('👤 Basic profile information for personalization')).toBeInTheDocument();
    ...
    it('should show features preview', () => {
      ...
      expect(screen.getByText('Connect your Google Calendar and manage meeting bots')).toBeInTheDocument();
      expect(screen.getByText('Generate AI-powered social media posts from transcripts')).toBeInTheDocument();
      expect(screen.getByText('Create professional follow-up emails automatically')).toBeInTheDocument();
